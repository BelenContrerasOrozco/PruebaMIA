		...
		for j := 0; j < len(param); j++ {
			if param[j] == "-size" || param[j] == "-SIZE" {
				...
				if valor_size <= 0 {
					...
					fmt.Println("")
					fmt.Println("----------------------------------------------------------------")
					fmt.Println("**!Valor de SIZE incorrecto")
					fmt.Println("----------------------------------------------------------------")
					fmt.Println("")
				} else {
					bandera_size = true
...
func crearParticionPrimaria(psize int, punit string, ppath string, pfit string, pnombre string, archivo string) {
	...
	if flagParticion {
		...
		if (mbr.Mbr_tamano - int64(espacioUsado)) >= int64(size_bytes) {
			if !existeParticion(auxPath, pname) {
				if mbr.Dsk_fit == 'F' { //FIRST FIT
					...
					if archivo == "principal" {
						fmt.Println("")
						fmt.Println("--Particion primaria creada exitosamente")
						fmt.Println("")
				...
				fmt.Println("")
				fmt.Println("----------------------------------------------------------------")
				fmt.Println("**!PArticion existente, particion no creada")
				fmt.Println("----------------------------------------------------------------")
				fmt.Println("")
			}
		} else {
			fmt.Println("")
			fmt.Println("----------------------------------------------------------------")
			fmt.Println("**!Espacio insuficinete")
			fmt.Println("----------------------------------------------------------------")
			fmt.Println("")
		}
	} else {
		fmt.Println("")
		fmt.Println("----------------------------------------------------------------")
		fmt.Println("**!Numero maximo de particiones creadas")
		fmt.Println("----------------------------------------------------------------")
		fmt.Println("")
	}
}
...
func crearParticionExtendida(psize int, punit string, ppath string, pfit string, pnombre string, archivo string) {
	...
	if !flagExtendida {
			...
			if (mbr.Mbr_tamano - int64(espacioUsado)) >= int64(size_bytes) {
				if !(existeParticion(auxPath, pname)) {
					if mbr.Dsk_fit == 'F' { //FIRST FIT
						...
						if archivo == "principal" {
							fmt.Println("")
							fmt.Println("--Particion extendida creada exitosamente")
							fmt.Println("")
					...
					fmt.Println("")
					fmt.Println("----------------------------------------------------------------")
					fmt.Println("**!Particion existenete, particion no creada")
					fmt.Println("----------------------------------------------------------------")
					fmt.Println("")
				}
			} else {
		...
		fmt.Println("")
		fmt.Println("----------------------------------------------------------------")
		fmt.Println("**!Particion extendida existente")
		fmt.Println("----------------------------------------------------------------")
		fmt.Println("")
	}
}
...
func crearParticionLogica(psize int, punit string, ppath string, pfit string, pnombre string, archivo string) {
	...
	if !existeParticion(auxPath, pname) {
		if numExtendida != -1 {
			...
			if ebr.Part_size == 0 { //Si es la primera
				if mbr.Mbr_partition[numExtendida].Part_size < int64(size_bytes) {
					if archivo == "principal" {
						fmt.Println("")
						fmt.Println("----------------------------------------------------------------")
						fmt.Println("**!Espacio insuficiente en particion extendida")
						fmt.Println("----------------------------------------------------------------")
						fmt.Println("")
					}
				} else {
			...
			fmt.Println("")
			fmt.Println("----------------------------------------------------------------")
			fmt.Println("**!Crear particion extendida para particion logica")
			fmt.Println("----------------------------------------------------------------")
			fmt.Println("")
		}
	} else {
